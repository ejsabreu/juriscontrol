...
const janela = { localStorage: criarStorage(), location: { href: 'file:///index.html' } };
const sandbox = {
...
const ARQUIVOS = [
  ...
  'src/domain/alertas.js', 'src/domain/classificador.js',
  'data/seed.js',
  'src/store/store.js',
  'src/services/http.js', 'src/services/db.js',
  'src/services/sessaoService.js', 'src/services/auditoriaService.js',
  'src/services/notificacaoService.js', 'src/services/regraAlertaService.js',
  'src/services/simulado/emailService.js',
  'src/services/publicacaoService.js', 'src/services/monitoramentoService.js',
