...
/* localStorage de mentira — a sessão e o banco precisam de um lugar para
   persistir, e sem ele metade das regras não seria exercitada de verdade. */
...
const janela = { localStorage: criarStorage() };
...
App.services.http.config.ativarLatencia = false;   // teste não espera rede fingida
